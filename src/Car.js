        ...
        <div class="flex-row">
            <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <img src={require('./img/home_1.png')} class="d-block w-100" alt="..."/>
                    ...
                    <img src={require('./img/home_2.png')} class="d-block w-100" alt="..."/>
                    <div class="carousel-caption d-none d-md-block">
                    ...
                    <img src={require('./img/home_3.png')} class="d-block w-100" alt="..."/>
                    <div class="carousel-caption d-none d-md-block">
